  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h2 className="text-xl font-bold text-white">System Analytics & Performance Charts</h2>
          <p className="text-xs text-gray-400">Editorial quality score trajectories and autonomous publishing velocity.</p>
        </div>
      </div>
